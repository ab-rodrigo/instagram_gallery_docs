document.addEventListener("DOMContentLoaded", function () {
    ...
    function applyTheme(theme) {
        ...
        localStorage.setItem("instagram-gallery-docs-bs-theme", theme);
    ...
    const savedTheme = localStorage.getItem("instagram-gallery-docs-bs-theme");
    ...
    document.querySelectorAll(".lang-option").forEach(function (link) {
        ...
        link.addEventListener("click", function () {
            ...
            const manualPath = originalHref.replace(
                "../",
                "../instagram-gallery-docs/"
            );

            localStorage.setItem("instagram-gallery-docs-user-manual-lang", manualPath);
        });
    });
});